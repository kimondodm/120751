...
{
    $url = "https://ehealth.co.ke";
    $link = $url . "opt-out.php?user=$email&code=$dcode";

    // Compose the email body with a link to opt out of OurChat.
    $body = "<div style='background-color: #77d7c8;' > <div style='background-color: black; color: #77d7c8; text-align: center;'><h2>E-Health</h2></div> <div style='text-align: center; color: black; background-color: #77d7c8; padding: 5%;'><p>Thank you for choosing E-Health. </p><p>Visit <a href='$url'>OurChat</a> to talk to friends in real time. </p><br><br><span style='font-size: 0.85em;'>Didn't sign up? <a href='$link'>Opt out</a> of E-Health.</span> </div> </div>";

    // Compose an alternative text-only version of the email.
    $altbody = "Thank you for choosing E-Health. Visit https://ehealth.co.ke/  to save your medical records. \n\nDidn't sign up? Use the link below to opt out of E-Health. \n$link";
...
function send_email($user, $subject, $body, $altbody)
{
    ...
    $mail->setFrom('no-reply@otanga.co.ke', 'E-Health');
